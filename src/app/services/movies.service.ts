...
export class MoviesService {
    ...
    apiKey: string = '1d7dd2e4e042d9683aebfa0866a8cd72';
    ...
    // Add pagination after url is popular?
    ...
    getTvs(type: string = 'latest', count: number = 12) {
        return this.http
            .get<TvDto>(`${this.baseUrl}/movie/${type}?api_key=${this.apiKey}`)
            .pipe(
                switchMap((res) => {
                    return of(res.results.slice(0, count));
                })
